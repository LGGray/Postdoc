...
lapply(unique(adult_metadata$organ_age), function(x) {
  ...
  rep1 <- fread(paste0('adult/', samples[1], '/merged_locus_table.txt'))
  rep2 <- fread(paste0('adult/', samples[2], '/merged_locus_table.txt'))
  rep3 <- fread(paste0('adult/', samples[3], '/merged_locus_table.txt'))
...
lapply(unique(aged_metadata$organ_age), function(x) {
  ...
  rep1 <- fread(paste0('aged/', samples[1], '/merged_locus_table.txt'))
  rep2 <- fread(paste0('aged/', samples[2], '/merged_locus_table.txt'))
  rep3 <- fread(paste0('aged/', samples[3], '/merged_locus_table.txt'))
...
lapply(unique(tac_metadata$condition), function(x) {
  ...
  rep1 <- fread(paste0(samples[1], '/merged_locus_table.txt'))
  rep2 <- fread(paste0(samples[2], '/merged_locus_table.txt'))
  rep3 <- fread(paste0(samples[3], '/merged_locus_table.txt'))
